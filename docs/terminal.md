...
bits during installation, including published/npm-installed Dancher Agent web packages.

Dancher Agent web pins node-pty to `1.2.0-beta.15`, which includes Linux x64 and ARM64
...
Restart Dancher Agent web after repair.
