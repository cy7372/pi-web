...
Dancher Agent web's integrated sub-agent implementation is an inline, hidden extension.
...
When the integrated extension is disabled, Dancher Agent web does not suppress the legacy
