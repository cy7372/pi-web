...
Dancher Agent web's interface uses a small internal i18n layer. It is intentionally kept
...
/** Dancher Agent web Japanese language package. */
...
Dancher Agent web is a user-facing web interface. Internationalization is therefore an
...
support should lower the barrier to using Dancher Agent web, not be treated as a measure
