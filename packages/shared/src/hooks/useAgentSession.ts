...
export function useAgentSession(opts: UseAgentSessionOptions) {
  ...
  const [truncationBanner, setTruncationBanner] = useState<string | null>(null);  const [compactError, setCompactError] = useState<string | null>(null);
    ...
    try {
      ...
      try {
        ...
        if (liveState) {
          ...
          setTruncationBanner(null);        } else if (!agentState.running) {
  ...
  return {
    ...
    autoCompactionEnabled, truncationBanner,    slashCommands, slashCommandsLoading, queuedMessages,
