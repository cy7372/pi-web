...
- `latte/` is used in Dancher Agent web's light theme.
- `mocha/` is used in Dancher Agent web's dark theme.
- Dancher Agent web uses the SVG alpha channel as a mask and applies `var(--text-dim)`,
