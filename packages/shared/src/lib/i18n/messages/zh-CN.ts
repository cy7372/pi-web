...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.title": "设置",
    "settings.general": "常规",
    "settings.generalDescription": "选择 Dancher Agent web 的显示方式和界面语言。",
    ...
    "agents.close": "关闭",
    "agents.builtInTitle": "启用 Dancher Agent web 内置子代理",
    "agents.builtInDescription":
      "提供 Dancher Agent web 集成的 Agent 工具，并停用发生冲突的 pi-subagents 扩展。",
    ...
    "appUpdate.releaseNotes": "Dancher Agent web v{version} 可用，查看更新说明",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    "theme.light": "主题：浅色",
    "theme.dark": "主题：深色",
    ...
    "chat.extensionNumberHint": "按 1-{count} 快速选择",
    ...
    "chat.stop": "停止",
    "agent.extensionTurnStart": "扩展触发了新一轮运行",
    "agent.runAborted": "运行已中断",
    ...
    "chat.commandAutoCompact": "开启/关闭自动上下文压缩",
    ...
    "i18n.compactFilesReadCount": "{count} 个已读",
    "i18n.compactFilesModifiedCount": "{count} 个已修改",
    "i18n.compactionExpand": "展开压缩摘要",
    "i18n.compactionCollapse": "收起压缩摘要",
