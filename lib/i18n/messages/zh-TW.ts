...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.commandAutoCompact": "開啟/關閉自動上下文壓縮",
    ...
    "i18n.compactFilesReadCount": "{count} 個已讀",
    "i18n.compactFilesModifiedCount": "{count} 個已修改",
    "i18n.compactionExpand": "展開壓縮摘要",
    "i18n.compactionCollapse": "收起壓縮摘要",
